...
def ServerRequestComm(name, base_comm=None, **kwargs):
    r"""Wrapper to produce ServerRequestComm with arbitrary comm base.
    ...
    Args:
        ...
        base_comm (str, optional): The name of the comm base class that should
            be used.
        **kwargs: Additional keyword arguments are passed to ServerRequestComm.

    Returns:
        ServerRequestComm: Communicator.

    """

    base = get_comm_class(base_comm)

    class ServerRequestComm(base):

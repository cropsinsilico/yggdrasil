...
class RMQAsyncServerDriver(RMQAsyncDriver, RPCDriver):
    ...
    def __init__(self, name, args=None, **kwargs):
        if args is None:
            args = name + '_SERVER'
        super(RMQAsyncServerDriver, self).__init__(name, queue=args, **kwargs)
        self.debug()
        self.clients = set([])
    ...
    def on_queue_declareok(self, method_frame):
        ...
        self.purge_queue()
        super(RMQAsyncServerDriver, self).on_queue_declareok(method_frame)
    ...
    def stop_communication(self):
        ...
        super(RMQAsyncServerDriver, self).stop_communication(cancel_consumer=True)

    def on_model_exit(self):
        r"""Explicitly call both RMQAsyncDriver and RPCDriver versions."""
        super(RMQAsyncServerDriver, self).on_model_exit()

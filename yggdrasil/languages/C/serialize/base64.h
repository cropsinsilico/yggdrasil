...
/*!
 ...
 @param[in,out] out_len: Pointer to output length variable, or %NULL if not
   used
 @returns Allocated buffer of out_len bytes of encoded data, or %NULL on
   failure
...
/*!
 @brief base64_decode - Base64 decode
 @param[in] src Data to be decoded
 @param[in] len Length of the data to be decoded
 @param[in,out] out_len Pointer to output length variable

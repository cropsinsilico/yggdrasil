...
while True:
    ...
    if not flag:
        ...
        break
    print('shoot: Received next time step: {:f}'.format(dt))
    ...
    print('shoot: Received next root mass: {:f}'.format(R_tp1))

    # Calculate shoot mass
    S_tp1 = calc_shoot_mass(r_s, dt, S_t, R_t, R_tp1)
    print('shoot: Calculated next shoot mass: {:f}'.format(S_tp1))

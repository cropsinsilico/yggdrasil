...
#     test_len = 1820
#     parts = [([(test_len - 10) * 'A'], {'PATH': (test_len - 10) * 'A'}),
#              ([test_len * 'A', test_len * 'B', test_len * 'C'],
#               {'YGG_PATH0': (test_len * 'C'),
#                'YGG_PATH1': (test_len * 'B') + os.pathsep + '%YGG_PATH0%',
#                'PATH': (test_len * 'A') + os.pathsep + '%YGG_PATH1%'})]
#     for a, b in parts:

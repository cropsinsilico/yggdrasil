...
:done
@endlocal & set LIBSODIUM_SOURCEDIR=%LIBSODIUM_SOURCEDIR% & set LIBZMQ_SOURCEDIR=%LIBZMQ_SOURCEDIR% & set LIBZMQ_BUILDDIR=%LIBZMQ_BUILDDIR% & set ZEROMQ_LIBRARY_DIR=%ZEROMQ_LIBRARY_DIR% & set CZMQ_SOURCEDIR=%CZMQ_SOURCEDIR% & set CZMQ_BUILDDIR=%CZMQ_BUILDDIR% & set CZMQ_LIBRARY_DIR=%CZMQ_LIBRARY_DIR%
...
:done
@endlocal & set LIBSODIUM_SOURCEDIR=%LIBSODIUM_SOURCEDIR% & set LIBZMQ_SOURCEDIR=%LIBZMQ_SOURCEDIR% & set LIBZMQ_BUILDDIR=%LIBZMQ_BUILDDIR% & set CZMQ_SOURCEDIR=%CZMQ_SOURCEDIR% & set CZMQ_BUILDDIR=%CZMQ_BUILDDIR% & set PATH=%PATH%;%ZEROMQ_LIBRARY_DIR%;%CZMQ_LIBRARY_DIR% & set PATH=%PATH%;%ZEROMQ_INCLUDE_DIR%;%CZMQ_INCLUDE_DIR%